...
const isPositiveNumber = (value: string) =>
    !isNaN(Number(value)) && Number(value) > 0 ? null : 'Must be a positive number.';
        ...
        <form onSubmit={handleSubmit} className="pb-5 space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.proposalTitle ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                        />
                        {errors.proposalTitle && <p className="text-red-500 text-sm mt-2">{errors.proposalTitle}</p>}
                    </div>
                    <div>
                        <label className="block text-sm font-medium">Proposal Category</label>
                        <select
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.requestedAmount ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                        />
                        {errors.requestedAmount && <p className="text-red-500 text-sm mt-2">{errors.requestedAmount}</p>}
                    </div>
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.submissionDate ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                        />
                        {errors.submissionDate && <p className="text-red-500 text-sm mt-2">{errors.submissionDate}</p>}
                    </div>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input
                            ...
                            value={formData.name}
                            onChange={handleInputChange}
                            className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.surname ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                        />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleInputChange}
                            className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                        />
            ...
            <section>
                ...
                <div className="mt-6">
                    ...
                    <textarea
                        ...
                        onChange={handleInputChange}
                        className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.proposalGoal ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                    />
                    {errors.proposalGoal && <p className="text-red-500 text-sm mt-2">{errors.proposalGoal}</p>}
                </div>
                <div className="mt-6">
                    ...
                    <textarea
                        ...
                        onChange={handleInputChange}
                        className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.expectedImpact ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                    />
                    {errors.expectedImpact && <p className="text-red-500 text-sm mt-2">{errors.expectedImpact}</p>}
                </div>
                <div className="mt-6">
                    ...
                    <textarea
                        ...
                        onChange={handleInputChange}
                        className={`mt-1 block w-full px-3 py-2 bg-white border ${errors.timeline ? 'border-red-500' : 'border-gray-300'} rounded-md shadow-sm focus:outline-none focus:ring-primary-3 focus:border-primary-3 sm:text-sm`}
                    />
            ...
            <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label className="block text-sm font-medium">Reference Letter</label>
                        <input
                            type="file"
