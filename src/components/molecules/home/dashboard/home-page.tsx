...
const HomePage = () => {
    return (
        <div className='w-full h-full space-y-11'>
            <h1 className='text-bleck font-bold text-xl' style={lora.style}>Dashboard</h1>
            ...
            <div className="flex jsutify-between items-start w-full">
                <div className="w-3/5 space-y-14">
                    <div className="space-y-4">
                        <div className="flex items-center py-4 px-5 h-52 bg-gradient-to-r from-[#00D3D3] via-[#00A0A0]/70 to-[#006D6D]/30 rounded-md">
                            <div className="space-y-4">
                                <h2 className="text-primary-3 font-bold text-xl" style={lora.style} >Welcome, Hroon</h2>
                                <p className="text-sm font-medium text-white" style={nunito.style}>Welcome to your LearnFi Student Dashboard, Haroon! Here, you can manage your proposals, loans, and resources to support your educational journey</p>
                                <div className=""></div>
                            </div>
                        ...
                        <div className="flex justify-between w-3/5 items-center" style={nunito.style}>
                            <Link href="/create-proposal">
                                <button className='bg-primary-3 text-sm rounded-lg px-4 py-2 text-white'>Create proposal</button>
                            </Link>
                            <Link href="/create-proposal">
                                <button className='bg-primary-2 text-sm rounded-lg px-4 py-2 text-primary-1'>View loan schedule</button>
                            </Link>
                        </div>
                    </div>

                    <div className="grid gap-x-4 gap-y-6 grid-cols-2 md:grid-cols-3 justify-between">
                        {proposal.map((item) => (<ProposalCard key={item.id} icon={item.image} value={item.value} title={item.title} yields={item.yields} iconYield={item.iconYield} />))}
                    </div>
                ...
                <div className="w-2/5 bg-primary-2">
                    <div className="">
                        ...
                        <h1 className='text-bleck font-bold text-xl' style={lora.style}>Community forum</h1>
                    ...
                    <div className="">
                        ...
                        <h1 className='text-bleck font-bold text-xl' style={lora.style}>Notifications</h1>
            ...
            <div className="container mx-auto">
                ...
                <div className="text-right mt-4">
                    <Link href="/dashboard/my-proposal" className="text-black font-bold">All Proposals</Link>
                </div>
            </div>
